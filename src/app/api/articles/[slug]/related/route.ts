// ============================================================================
// app/api/articles/[slug]/related/route.ts — GET related articles by tag.
// ==========================================================================
...
export async function GET(
  ...
  // Load the source article to read its tags + id.
  ...
  // Build a raw SQL OR condition for tag matching.
